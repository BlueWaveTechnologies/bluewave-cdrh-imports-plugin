...
public class Ports {
  ...
  //** downloadUSPortsofEntry
  //**************************************************************************
    public static void downloadUSPortsofEntry(HashMap<String, String> args) throws Exception {
        new bluewave.data.cdrh.Ports().downloadUSPortsofEntry(args.get("-path"));
    }

  //**************************************************************************
  //** loadUSPortsofEntry
  //**************************************************************************
    public static void loadUSPortsofEntry(HashMap<String, String> args) throws Exception {
        Neo4J database = Config.getGraph(null);
        loadUSPortsofEntry(new javaxt.io.File(args.get("-path")), database);
        database.close();
    }
