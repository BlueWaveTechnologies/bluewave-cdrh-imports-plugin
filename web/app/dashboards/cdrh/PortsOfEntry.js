...
if(!bluewave.dashboards.cdrh) bluewave.dashboards.cdrh={};
...
bluewave.dashboards.cdrh.PortsOfEntry = function(parent, config) {

    var me = this;
    var title = "Ports of Entry";
    var map, legend;
    var style = {};
    var layer = {};
    var table; //grid
...
//        if (!portsOfEntry){
//            get("data/us_ports_of_entry.csv",{
//                success: function(data){
//                    portsOfEntry = parseCSV(data, ",");
//                    console.log(portsOfEntry);
//                }
//            });
//        }
    ...
    var update = function(){
      ...
      //Fetch new data and update map
        getData("Imports_By_Port", function(_data){
